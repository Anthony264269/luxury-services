 ...
 */
final class Version20240308130035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidat DROP user_id, CHANGE first_name first_name VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE candidat ADD user_id INT DEFAULT NULL, CHANGE first_name first_name VARCHAR(255) NOT NULL');
